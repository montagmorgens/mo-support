...
if ( ! defined( 'Mo\Support\PLUGIN_VERSION' ) ) {
	define( 'Mo\Support\PLUGIN_VERSION', '1.4.1' );
}
...
\add_action( 'plugins_loaded', '\Mo\Support\Support_Status::get_instance' );
\add_action( 'plugins_loaded', '\Mo\Support\Cleanup::get_instance' );
